...
# How successful have Theatre campaigns been?

Our analysis shows that Theatre projects receive a **fairly good response** by crowdfunding sources. The success rate has a decent margin over failure rate.
...
# Can we say the same about Theatre Play campaigns?
...
# Alright then! When should we launch the campaign?

Based on trends, the month of **May** is a clear winner. It has seen a surprisingly high number of successful campaigns. However launching a campaign in *June* wouldn't be so bad either.
